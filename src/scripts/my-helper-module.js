...
//         // always loop
//         _.def = {
//           target: $('.room-card__slider'),
//           dotsWrapper: $('.room-card__slider-toogler'),
//           arrowLeft: $('.room-card__slider-left'),
//           arrowRight: $('.room-card__slider-right'),
//           transition: {
//             speed: 300,
//             easing: ''
//           },
...
//     
//         _.sliderInner = _.def.target.querySelector('.room-card__slider-container');
//         _.loadedCnt = 0;
//     
//         // append clones
...
//   
// 
// var sliders = document.querySelectorAll('.room-card__slider');
// sliders.forEach(function(item) {
//     return new slider_plugin({
//         target: item,
//         dotsWrapper: item.querySelector('.room-card__slider-toogler'),
//         arrowLeft: item.querySelector('.room-card__slider-left'),
//         arrowRight: item.querySelector('.room-card__slider-right')
//     });
// })
...
sliders.forEach(function(item) {
    return new slider_plugin({
        target: item,
        dotsWrapper: item.querySelector('.dots-wrapper'),
        arrowLeft: item.querySelector('.arrow-left'),
        arrowRight: item.querySelector('.arrow-right')
    });
})